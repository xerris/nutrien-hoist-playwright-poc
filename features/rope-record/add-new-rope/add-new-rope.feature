...
Feature: Rope Records
  ...
  Background:
    ...
    Scenario: Add new rope with Unique Serial Number
      Given I provide the following rope information with 'Unique' serial number
        | Rope type                      | Head rope  |
        | Hoist #                        | 1          |
    ...
    Scenario: Add new rope with Duplicate Serial Number
      And I provide the following rope information with 'Duplicate' serial number
        | Rope type                      | Head rope     |
        | Hoist #                        | 1             |
        | Serial number                  | CUCSNO168681  |
        | Diameter of rope (optional)    | 1234          |
        | Weight of rope                 | 123           |
        | Construction of rope           | abcd          |
        | Type of lay                    | N/A           |
