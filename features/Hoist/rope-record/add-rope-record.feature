...
Feature: Rope Records
  ...
  Scenario: Add rope record
    ...
    Given I click on Rope Information Accordian Tab
    And I provide the required rope information
    Given I click on Construction Info Accordian Tab
    And I Provide information for construction info form
    Given I click on Breaking load test Info Accordian Tab
